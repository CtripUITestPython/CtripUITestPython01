# @summary --- Jerry
# 1.Verify the content of the accidental health module.
...
def run(playwright: Playwright) -> None:
    ...
    # Unexpected_health
    Unexpected_health(context, page)
...
#   Unexpected_health
def Unexpected_health(context: BrowserContext, page: Page) -> None:
    ...
    page.locator('div.index_filter.index-filter-new div.left-tab:nth-child(2) div.tab-item:nth-child(2)').click()
    page.locator('div.pro-tit.line2:nth-child(1)').click()
    # "Login"  -> "Special protection"-> "Preview" -> "Close"
    page.locator('.form_wrap:nth-child(2) .bbz-js-iconable-input[data-testid="accountNameInput"]').fill('19865043369')
    ...
    page.get_by_role('link',name="特殊保障").click()
    page.wait_for_timeout(5000)
