# @summary --- Jerry
# 1.Verify the content of the surrounding free travel module
...
def run(playwright: Playwright) -> None:
    ...
    # Surrounding_independent_travel
    Surrounding_independent_travel(context, page)
...
# Surrounding_independent_travel
def Surrounding_independent_travel(context: BrowserContext, page: Page) -> None:
    ...
    page.locator('.more_a:nth-child(4)').click()
    # "Departing from Shanghai" -> "3 days" -> "Sales priority" 
    page.locator('.list_cate_select.basefix.list_cate_height:nth-child(2)').filter(has_text='上海').click()
    ...
    if page.locator('.list_product_box.js_product_item:nth-child(1)').all() == 0:
